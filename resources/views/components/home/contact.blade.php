...
<section id="contact" class="bg-white dark:bg-blue-400 lg:py-[120px]  overflow-hidden relative z-10">
  <div class="container">
    <div class="flex flex-wrap lg:justify-between -mx-4 ">
      <div class="w-full lg:w-1/2 xl:w-6/12 px-4 ">
        <div class="mb-12 max-w-[570px] lg:mb-0">
          ...
          <p class="text-base text-body-color dark:text-slate-200 mb-9  leading-relaxed">
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              ...
              <p class=" text-body-color dark:text-slate-200 text-base">
                Rwalpindi pakistan
              </p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              ...
              <p class="text-base text-body-color dark:text-slate-200">(+92)3095629259</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div class="w-full">
              ...
              <p class="text-base text-body-color dark:text-slate-200">kingbalti00@gmail.com</p>
            </div>
          </div>
        </div>
        </div>
...
<div class="mb-6">
              ...
              <x-forms.input
                type="text"
                placeholder="Your Name" name="name" id="exampleInputName" value="{{old('name')}}"
    ...
    @enderror
            ...
            <div class="mb-6">
              <x-forms.input
                type=""
                placeholder="Your Email" name="email" id="exampleInputName"  value="{{old('name')}}" 
        ></x-forms.input>
    ...
    @enderror
            ...
            <div class="mb-6">
              <x-forms.input
                type="text"
                placeholder="Your Phone" name="phone" id="exampleInputName"  value="{{old('name')}}"
        ></x-forms.input>
        <span class="text-danger ">
        @error('phone')
    {{$message}}
    @enderror
            ...
            <div class="mb-6">
              <x-forms.textarea
                rows="6"
                placeholder="Your Message" name="message" id="exampleInputName"  value="{{old('name')}}"
           ></x-forms.textarea>
           <span class="text-danger">
           @error('message')
    {{$message}}
