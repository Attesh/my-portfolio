...
<!-- ====== Hero Section Start -->
<div class="relative bg-white dark:bg-slate-800  pt-[120px] pb-[110px] lg:pt-[150px] ">
  <div class="container ">
    <div class="-mx-4 flex flex-wrap">
      <div class="w-full px-4 lg:w-5/12">
        ...
        <h1
          ...
          >
            My Name is Zeeshan Ali <br />
            I am  <br />
            a freelancer.
          </h1>
          <p class="text-body-color mb-8 max-w-[480px] text-base">
            i am a developer less one year of experience.
            i love to work with you to make a website project special php in laravel.
          </p>
