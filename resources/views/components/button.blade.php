<button
  ...
  {{ $attributes -> class([
    ...
    'hover:bg-red hover:border-red-700 hover:text-white' => $variant = 'outline-red',
   ...
   ' bg-primary border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90',
    ])
